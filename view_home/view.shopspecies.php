<?php if (isset($_GET['search'])):
  $search = decrypt_url($_GET['search']);
  ...
  $prev = $pages - 1;
  $next = $pages + 1;
  $sqlresultsearch = "SELECT * FROM fs_product WHERE id_species = '$search'";
  ...
  WHERE a.id_species = '$search' LIMIT $start, $paging";
           ...
           <td>
             <div class="card shadow mb-4">
               <div class="card-header py-3 bg-secondary">
                 <h6 class="m-0 font-weight-bold text-white"><?php echo $shop['species_name']; ?> (<?php echo $shop['product_name']; ?>)</h6>
               </div>
               <div class="card-body">
